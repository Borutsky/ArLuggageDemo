...
import com.example.bottomsheetapptest.ArBottomSheetFragment
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        initArFragment()
        //initListeners()
        val arBottomSheetFragment: ArBottomSheetFragment = ArBottomSheetFragment()
        arBottomSheetFragment.show(supportFragmentManager, "BOTTOM_SHEET_FRAGMENT_TAG")
    }
